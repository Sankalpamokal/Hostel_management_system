...
$sql = "SELECT hbuilding,floorno,roomno,allocated,fname,username,mobile FROM addroom LEFT JOIN allocate ON addroom.roomno=allocate.aroomno ORDER BY hbuilding";
