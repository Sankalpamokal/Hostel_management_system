...
<h2 style="text-align:center;font-size:2vw;">REPORT COLLEGE WISE</h2>
<?php
include_once("config.php"); 

$sql = "SELECT college,fname,roomno,username,mobile FROM allocate LEFT JOIN addroom ON allocate.aroomno=addroom.roomno";
