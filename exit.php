...
<div id="radio" style="padding-bottom: 20px">
        <input type="radio" name="source" value="entry" id="entry" onclick="javascript:window.location.href='entry.php'; return false;">Entry   
          <input type="radio" name="source" value="exit" id="exit" onclick="javascript:window.location.href='exit.php'; return false;" checked>Exit
        </div>
...
<br/>
<br/><center><input type="submit" name="submit" value="Entry" ></center>
</form>
</div>
<br/>
<br/>
