...
<div id="radio" style="padding-bottom: 20px">
        <input type="radio" name="source" value="allocate" id="allocate" onclick="javascript:window.location.href='allocation.php'; return false;"  >Allocation/Reject  
          <input type="radio" name="source" value="dealloacte" id="deallocate" onclick="javascript:window.location.href='deallocation.php'; return false;" >Deallocation
          <input type="radio" name="source" value="sinfo" id="sinfo" onclick="javascript:window.location.href='sinfo.php'; return false;" checked >Student Info
        </div>
<form method="post" action="sinfodata.php">
...
<br/>
<br/>
<input type="submit" name="allocate" value="Show" >
</form>
</div>
<div><br/>
