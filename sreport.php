...
<h2 style="text-align:center;font-size:2vw;">REPORT STUDENT WISE</h2>
<?php
include_once("config.php"); 

$sql = "SELECT fname,username,mobile,roomno,college FROM allocate LEFT JOIN addroom ON allocate.aroomno=addroom.roomno";
